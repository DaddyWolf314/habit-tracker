/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f1e4fab0838e7f9559e04df00839b683)
// Runtime types generated with workerd@1.20260701.1 2025-09-02 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	DATABASE_URL: string;
	COUPLE_DO: DurableObjectNamespace<import("./src/server").CoupleDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "CoupleDO";
	}
